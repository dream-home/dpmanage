					...
					if(this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
						...
						var o = function(a, b) {
							...
							ka = function(c, d) {
								...
								f === "rtl" && (g = g + i);
								a.p.pginput === true && (e = "<td dir='" + f + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' disabled='disabled' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" +
