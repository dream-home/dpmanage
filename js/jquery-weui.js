...
+ function($) {
  ...
  $.toast = function(text, style, callback) {
    ...
    show('<i class="weui_icon_toast"></i><p class="weui_toast_content">' + (text || "宸茬粡瀹屾垚") + '</p>', className);
  ...
  $.showLoading = function(text) {
    ...
    html += '</div>';
    html += '<p class="weui_toast_content">' + (text || "鏁版嵁鍔犺浇涓�") + '</p>';
  ...
  var show = function(params) {
    ...
    var tpl = '<div class="weui_actionsheet " id="weui_actionsheet">'+
                ...
                '<div class="weui_actionsheet_action">'+
                  '<div class="weui_actionsheet_cell weui_actionsheet_cancel">鍙栨秷</div>'+
                  '</div>'+
                '</div>';
    var dialog = $(tpl).appendTo(document.body);
...
+ function($) {
  ...
  Datetime.prototype = {
    ...
    arrayToDate: function(arr) {
      ...
      //娉ㄦ剰杩欑鏍煎紡 "2012-12-12 12:12" 鍦╥os涓婃槸閿欒鐨勶紝濡傛灉鐢� "2012-12-12T12:12" 鏄鐨勶紝浣嗘槸杩欎釜鏄爣鍑嗘椂鍖鸿€屼笉鏄笢鍏尯锛屾墍浠ヨ繖閲屽垎鍒缃�
      date.setHours(arr[3]);
